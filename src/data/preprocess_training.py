...
if __name__ == "__main__":
    # Clean the dataset
    cleaned = clean_training_dataset("/Users/joshbolton/ml_final_project/data/raw/train.csv")
    # Ensure the processed directory exists
    os.makedirs("data/processed", exist_ok=True)
    # Save the cleaned data
    processed_path = "/Users/joshbolton/ml_final_project/data/processed/cleaned_train.csv"
